...
[//]: # (3. Скомпилировать код в .class-файлы командой `javac -cp libs/pokemon.jar -d bin src/com/example/**/*.java` в терминале)

[//]: # (4. Далее сформировать .jar-файл командой в том же терминале `jar cvef com.example.Lab2 Laba2.jar -C bin .`)
...
[//]: # (2. Запустить программу командой `java -jar Laba2.jar` в терминале)
